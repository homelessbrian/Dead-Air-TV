...
android {
  ...
  val releaseKeystore = file("${rootDir}/channelz-release.jks")
  ...
  signingConfigs {
    create("release") {
      if (releaseKeystore.exists()) {
        ...
        storePassword = System.getenv("STORE_PASSWORD") ?: "channelz-tv"
        keyAlias = "channelz"
        keyPassword = System.getenv("KEY_PASSWORD") ?: "channelz-tv"
